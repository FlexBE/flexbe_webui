...
@pytest.mark.parametrize('case_name', [
    ...
    'render_config',
    'tuple_parameter',
    'state_parameter_doc_type_validation',
    ...
    'runtime_flows',
    'runtime_deepest_state',
    'runtime_pinned_level',
    'runtime_pinned_status_cleanup',
    'runtime_outcome_request_focus',
    'controller_external_prompt_preserves_terminal',
    'pubsub_outcome_request_before_state_map',
    'subscriber_callback_deferred',
    'subscriber_buffer_slice_recovery',
    'state_map_callback_state_id_assignment',
    'synthesis_payload',
    'synthesis_result_transition_geometry',
    'synthesis_form',
    'state_panel_flows',
    'state_properties_escape_close',
    ...
    'api_client',
    'helper_flows',
    'drawable_state_box_layer',
    'statemachine_home_end_pan',
    'statemachine_fit_view',
    'validation_report',
    'validation_style_suggestion_info',
    'terminal_safe_text',
    'remaining_html_sinks_safe_text',
    'events_flows',
    'command_update_behavior',
    'behaviorlib_update_sync_callback',
    'command_qualified_behavior',
    'auto_layout_transition_geometry',
    'behavior_collision_resolution',
    'legacy_behavior_import_resolution',
    'helper_class_skipped',
    'behavior_loader_failure',
    ...
    'behavior_loader_session_record',
    'behavior_loader_restore_failure_keeps_session',
